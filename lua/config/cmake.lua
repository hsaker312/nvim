...
function CMake.setup()
    ...
    vim.keymap.set("n", "<leader>cc", "<cmd> CMakeClean <CR>", { noremap = true, silent = true, desc = "CMake Clean" })
    ...
    vim.keymap.set(
        ...
        { noremap = true, silent = true, desc = "CMake Output" }
    )
    ...
    vim.keymap.set(
        ...
        { noremap = true, silent = true, desc = "CMake Configuration Preset" }
    )
    ...
    vim.keymap.set(
        ...
        { noremap = true, silent = true, desc = "CMake Build Preset" }
    )
